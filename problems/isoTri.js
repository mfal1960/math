...
function draw(){
        ...
        let diag1=Math.sqrt(Math.pow(width1*.5,2)+Math.pow(hei1,2));
        let diag1Dim=rounding(diag1*scale,"thousandth");            
        let perimeter = rounding(width1Dim+diag1Dim*2,"tenth");
        let area = rounding(width1Dim*diag1Dim*.5,"tenth"); 
...
//DIMENSIONAL LINES
        ...
        drawArrowDiag(ctx,figX+width1*.5+20,figY-hei1,figX+width1+20,figY,diag1Dim,measur,-50);
        drawArrowDiag(ctx,figX+width1*.5-20,figY-hei1,figX-20,figY,diag1Dim,measur,-100);
        //drawArrowHoriTop(x,y,l,text,meas,offSet)
        drawArrowHoriTop(ctx,figX,figY,width1,width1Dim,measur,50);
