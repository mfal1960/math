...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function paddleBoard(){
            let paddleBoardAr=[];
            paddleBoardAr.push({item:"paddle board",cost:"345.00",type:"paddle board"});
            paddleBoardAr.push({item:"life jacket",cost:"34.67",type:"paddle board"});
            paddleBoardAr.push({item:"pump",cost:"43.99",type:"paddle board"});
            let rand=Math.floor(Math.random()*paddleBoardAr.length);
            return paddleBoardAr[rand];
        }
