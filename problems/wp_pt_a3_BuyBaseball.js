...
function draw(){
        ...
        let nam=names();
        let cost = rounding((item1Price+item2Price+item3Price)*(1+stateTax/100),"hundredth");
        
        let question=nam+" went to the sporting goods store and purchase a "+item1Name+" for $"+item1Price+", a "+item2Name+" for $"+item2Price+" and a "+item3Name+" for $"+item3Price+",.  If the state sales tax was "+stateTax+"%, how much did "+nam+" pay for the items?";
