...
function draw(){
        ...
        let adCI1=createMixNumbers(); 
        let adCI2=createMixNumbers();
        let adCI3=createMixNumbers();
        let adCI4=createMixNumbers();
        let adCI5=createMixNumbers(); 
        let ad1=mixFracToDec(adCI1)
        let ad2=mixFracToDec(adCI2)
        let ad3=mixFracToDec(adCI3);
        let ad4=mixFracToDec(adCI4);
        let ad5=mixFracToDec(adCI5);
        let sumAds=ad1+ad2+ad3+ad4+ad5; 
        ...
        let ques = "A newspaper charges $"+pricePerColumnInch+" per column inch.  If you place 5 ads of "+adCI1+" c.i., "+adCI2+" c.i., "+adCI3+" c.i. , "+adCI4+" c.i. ,and "+adCI5+" c.i., what is the total number of column inches you are purchasing as a mixed number, and how much will you be charged?"; 
        //**********WRITE ANSWER********** - 5 OF 7 
