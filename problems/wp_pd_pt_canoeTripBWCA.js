...
function wp_pd_pt_canoeTripBWCA(){   
//size 150
...
function draw(){
        ...
        if(randomFriend==2){
            ...
            var discountPercent=Math.round(Math.ceil(Math.random()*2)*10);
            var discount=rounding(totalCostWithoutTax*(discountPercent/100),"hundredth");
            let costWidthDiscount=rounding(totalCostWithoutTax-discount,"hundredth");
            console.log(discountPercent)

           
            console.log(discount)
            
            console.log(costWidthDiscount)

            var tax=rounding(costWidthDiscount*stateTax/100,"hundredth");
            var totalCostWithTax=rounding(costWidthDiscount+tax,"hundredth");
            ...
            let question = "You and "+group+" are going on a canoe trip to the Boundary Waters Canoe Area (BWCA). You purchase a canoe for $"+canoeC+", "+(friends+1)+" canoe seats for $"+canoeSeatsC+", "+(friends+1)+" life jackets for $"+lifeJacketsC+", and "+(friends+1)+" paddles for $"+paddlesC+".  The store gave a "+discountPercent+"% discount, and the state sales tax is "+stateTax+"%. If you split the cost, how much will each of you pay?";
            var answer;
            if(remainder==0){
                answer = "The cost without tax is $"+totalCostWithoutTax+".  The discount is $"+discount+". The cost with discount is $"+costWidthDiscount+". The tax is $"+tax+".  The total cost is $"+totalCostWithTax+". Each person will owe $"+splitCost+".";
            }else{
            var discount=rounding(totalCostWithoutTax*(discountPercent/100),"hundredth");
                answer = "The cost without tax is $"+totalCostWithoutTax+".  The discount is $"+discount+". The cost with discount is $"+costWidthDiscount+". The tax is $"+tax+".  The total cost is $"+totalCostWithTax+". Each person will owe $"+splitCost+" with a remainer of $"+remainder;
            }
