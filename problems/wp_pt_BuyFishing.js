...
function draw(){
        ...
        let item=fishingVar("random");
        
        let item1Name=item.item;
        let item1Cost=item.cost;
       ...
       var question=name+" bought the following at a sporting goods store: "+item1Name+" for $"+item1Cost+". If the state sales tax is "+salesTax+"%, how much will "+name+" be charged?";
