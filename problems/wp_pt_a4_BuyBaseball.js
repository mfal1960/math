...
function draw(){
        ...
        let item1=baseballVar("single");
        let item2=baseballVar("single");
        let stateTax = Math.floor((Math.random()*1+6.5)*10)/10;
        let item1Name=item1[0].item;
        let item1Price=item1[0].cost;
        let item2Name=item2[1].item;
        let item2Price=item2[1].cost;
        let item3Name=item2[2].item;
        let item3Price=item2[2].cost;
        let item4Name=item2[2].item;
        let item4Price=item2[2].cost;
        
        let nam=names();
        let cost = rounding((item1Price+item2Price+item3Price+item4Price)*(1+stateTax/100),"hundredth");
        
        let question=nam+" went to the sporting goods store and purchase a "+item1Name+" for $"+item1Price+", a "+item2Name+" for $"+item2Price+" a "+item3Name+" for $"+item3Price+", and a "+item4Name+" for $"+item4Price+".  If the state sales tax was "+stateTax+"%, how much did "+nam+" pay for the items?";
        let answer=nam+" paid $"+cost+" for the items.";
...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        // function baseball(func){
        //     let baseballAr=[];
        //     baseballAr.push({item:"baseball",cost:"6.99",type:"baseball"});
        //     baseballAr.push({item:"baseball glove",cost:"16.45",type:"baseball"});
        //     baseballAr.push({item:"baseball bat",cost:"23.79",type:"baseball"});
        //     baseballAr.push({item:"batting helmet",cost:"34.95",type:"baseball"});
        //     var rand = Math.floor(Math.random()*baseballAr.length);
        //     if(func=="single"){
        //         return baseballAr;
        //     }
        //     if(func=="random"){
        //         return baseballAr[rand];
        //     }
        // }

        function baseballFix(func){
            let baseballFixAr=[];
            baseballFixAr.push({item:"baseball",cost:"6.99",type:"baseball"});
            baseballFixAr.push({item:"baseball glove",cost:"16.45",type:"baseball"});
            baseballFixAr.push({item:"baseball bat",cost:"23.79",type:"baseball"});
            baseballFixAr.push({item:"batting helmet",cost:"34.95",type:"baseball"});
       ...
       function baseballVar(func){ 
            let baseballVarAr=[];
            baseballVarAr.push({item:"baseball",cost:rounding(Math.random()*2+5.99,"hundredth"),type:"baseball"});
            baseballVarAr.push({item:"baseball glove",cost:rounding(Math.random()*7+15.45,"hundredth"),type:"baseball"});
            baseballVarAr.push({item:"baseball bat",cost:rounding(Math.random()*10+23.79,"hundredth"),type:"baseball"});
            baseballVarAr.push({item:"batting helmet",cost:rounding(Math.random()*5+32.95,"hundredth"),type:"baseball"});
