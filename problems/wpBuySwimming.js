...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function swimming(){
            let swimmingAr=[];
            swimmingAr.push({item:"swimsuit",cost:"26.96",type:"swimming"});
            swimmingAr.push({item:"swimming goggles",cost:"24.00",type:"swimming"});
            swimmingAr.push({item:"towel",cost:"15.45",type:"swimming"});
            let rand=Math.floor(Math.random()*swimmingAr.length);
            return swimmingAr[rand];
        }
