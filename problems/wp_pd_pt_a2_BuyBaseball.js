...
function wp_pd_pt_a2_BuyBaseball(){   
//size 150
...
function draw(){
        ...
        let sumItems=item1Price+item2Price;
        ...
        let question=nam+" went to the sporting goods store and purchased a "+item1Name+" for $"+item1Price+", and a "+item2Name+" for $"+item2Price+".  If there was a "+percentDiscount+"% discount and the state sales tax was "+stateTax+"%,  how much did "+nam+" pay for the "+item1Name+"?";
