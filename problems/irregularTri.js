...
function draw(){
        ...
        let figX=150;
        let figY=180;
        var vertMove=Math.round(getRandomInt(2, 8))*.1;      
        let width1=Math.round(Math.random()*50+100);
        let width1Dim=rounding(width1*scale,"thousandth");
        let hei1=Math.round(Math.random()*50+100);
        let hei1Dim=rounding(hei1*scale,"thousandth");        
        let widthL1=width1*vertMove; 
        let widthL1Dim=rounding(widthL1*scale,"thousandth");
        let widthR1=width1*(1-vertMove);     
        let widthR1Dim=rounding(width1Dim-widthL1Dim,"thousandth");
        let diagR1=Math.sqrt(Math.pow(widthR1,2)+Math.pow(hei1,2));
        let diagR1Dim=rounding(diagR1*scale,"thousandth");
        let diagL1=Math.sqrt(Math.pow(widthL1,2)+Math.pow(hei1,2));
        let diagL1Dim=rounding(diagL1*scale,"thousandth");
        let perimeter = rounding(width1Dim+diagR1Dim+diagL1Dim,"tenth");
        let area = rounding(width1Dim*hei1Dim*.5,"tenth"); 
...
//GEOMETRIC FIGURES
        ...
        drawIrregularTri(ctx,figX,figY,width1,-hei1,vertMove,"white","vert");
        
        //type is vert or hori
        //drawIsoTri(ctx,x,y,wid,hei,clr,type);
        //drawIsoTri(ctx,figX,figY,width1,-hei1,"white","vert");
...
//DIMENSIONAL LINES
        ...
        drawArrowVertRight(ctx,figX+width1,figY-hei1,hei1,hei1Dim,measur,20);

        //drawArrowDiag(ctx,x,y,x2,y2,text,meas,offSet)
       drawArrowDiag(ctx,figX+width1*vertMove+30,figY-hei1,figX+width1+30,figY,diagR1Dim,"ft.",-70);
       drawArrowDiag(ctx,figX+width1*vertMove-20,figY-hei1,figX-20,figY,diagL1Dim,measur,-170);
        ...
        drawArrowHoriBottom(ctx,figX,figY,width1,width1Dim,measur,10);
        drawArrowHoriBottom(ctx,figX,figY,widthL1,widthL1Dim,measur,40);
        drawArrowHoriBottom(ctx,figX+widthL1,figY,widthR1,widthR1Dim,measur,40);

        //drawArrowVertLeft(ctx,x,y,l,text,meas,offSet)
        drawArrowVertLeft(ctx,figX,figY-hei1,hei1,hei1Dim,measur,-30);
...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS - Must use above with variables
        function names(){
