...
function draw(){
        ...
        let recWid=100;
        let recHei=100;
        let recHeiDim=recHei*scale;
        let ropeLen=Math.ceil(Math.random()*60+40);
        let ropeLenDim=Math.round(ropeLen*scale);
        let ropeX1=figX+recWid;
        let ropeY1=figY;
        let ropeX2=ropeX1+ropeLen;
        let ropeY2=ropeY1-50;
       
        
        
        // let meas="ft."
        let perimeter = "perimeter";
        let area = rounding(Math.pow(ropeLenDim,2)*Math.PI*.75,placeValue); 
...
//DIMENSIONAL LINES
        ...
        //drawArrowHoriBottom(ctx,figX,figY+rectHei,rectWid,rectWidDim,meas,20);
