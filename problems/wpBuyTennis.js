...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function tennis(){
            let tennisAr=[];
            tennisAr.push({item:"tennis balls",cost:"3.94",type:"tennis"});
            tennisAr.push({item:"tennis racket",cost:"31.38",type:"tennis"});
            tennisAr.push({item:"tennis shorts",cost:"24.09",type:"tennis"});
            tennisAr.push({item:"headband",cost:"2.97",type:"tennis"});
            let rand = Math.floor(Math.random()*tennisAr.length);
            return tennisAr[rand];
        }
