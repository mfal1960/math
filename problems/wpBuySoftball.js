...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function softball(){
            let softballAr=[];
            softballAr.push({item:"softball",cost:"7.65",type:"softball"});
            softballAr.push({item:"softball glove",cost:"21.99",type:"softball"});
            softballAr.push({item:"softball bat",cost:"39.67",type:"softball"});
            softballAr.push({item:"batting helmet",cost:"34.97",type:"softball"});
            let rand=Math.floor(Math.random()*softballAr.length);
            return softballAr[rand];
        }
