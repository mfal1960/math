...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function basketball(){
            let basketballAr=[];
            basketballAr.push({item:"basketball shoes",cost:"69.95",type:"basketball"});
            basketballAr.push({item:"basketball",cost:"21.81",type:"basketball"});
            basketballAr.push({item:"basketball hoop",cost:"84.98",type:"basketball"});
            basketballAr.push({item:"basketball pump",cost:"6.49",type:"basketball"});
            let rand=Math.floor(Math.random()*basketballAr.length);
            return basketballAr[rand];
        }
