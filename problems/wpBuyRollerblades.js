...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function rollerblades(){
            let rollerbladesAr=[];
            rollerbladesAr.push({item:"rollerblades",cost:"66.99",type:"rollerblades"});
            rollerbladesAr.push({item:"helmet",cost:"26.79",type:"rollerblades"});
            rollerbladesAr.push({item:"pads",cost:"27.80",type:"rollerblades"});
            let rand=Math.floor(Math.random()*rollerbladesAr.length);
            return rollerbladesAr[rand];
        }
