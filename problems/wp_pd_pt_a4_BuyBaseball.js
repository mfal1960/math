...
function wp_pd_pt_a4_BuyBaseball(){   
//size 150
...
function draw(){
        ...
        let item2Name=item1[1].item;
        let item2Price=item1[1].cost; 
        let item3Name=item1[2].item;
        let item3Price=item1[2].cost; 
        let item4Name=item1[3].item;
        let item4Price=item1[3].cost; 
        let sumItems=item1Price+item2Price+item3Price+item4Price;
        let percentDiscount=Math.ceil(Math.random()*4)*10
        let nam=names();
        let cost = rounding(sumItems*(1-percentDiscount/100)*(1+stateTax/100),"hundredth");
        
        //rounding(item1Price*(1+stateTax/100),"hundredth");
        
        let question=nam+" went to the sporting goods store and purchased a "+item4Name+" for $"+item4Price+", a "+item3Name+" for $"+item3Price+", a "+item1Name+" for $"+item1Price+", and a "+item2Name+" for $"+item2Price+".  If there was a "+percentDiscount+"% discount and the state sales tax was "+stateTax+"%,  how much did "+nam+" pay for the "+item1Name+"?";
