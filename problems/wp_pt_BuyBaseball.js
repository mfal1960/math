...
function draw(){
        ...
        let nam=names();
        let cost = rounding(item1Price*(1+stateTax/100),"hundredth");
        
        let question=nam+" went to the sporting goods store and purchase a "+item1Name+", which cost $"+item1Price+".  If the state sales tax was "+stateTax+"%, how much did "+nam+" pay for the "+item1Name+"?";
