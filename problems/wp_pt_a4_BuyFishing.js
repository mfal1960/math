...
function draw(){
        ...
        var name=names();
        var cost = item2Cost+item3Cost+item4Cost+item5Cost+item6Cost;
        var totalCost=rounding(cost*(1+salesTax/100),"hundredth");
        
       var question=name+" bought the following at a sporting goods store: a "+item2Name+" for $"+item2Cost+", a "+item3Name+" for $"+item3Cost+", a "+item4Name+" for $"+item4Cost+", a "+item5Name+" for $"+item5Cost+", and a "+item6Name+" for $"+item6Cost+". If the state sales tax is "+salesTax+"%, how much will "+name+" be charged?";
