...
function a1GeometryTemplate__DoNotTouch(){   
...
function draw(){
        ...
        //**********WRITE ANSWER********** - 5 OF 7 
        let ans = "The circumference is "+perimeter+" feet.  The area is "+area+" square feet."
...
//DIMENSIONAL LINES
        ...
        drawArrowVertLeft(ctx,figX,figY-hei1,hei1,hei1Dim,"ft.",-30);
