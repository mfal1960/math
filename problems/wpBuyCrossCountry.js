...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function crossCountry(){
            let crossCountryAr=[];
            crossCountryAr.push({item:"cross country shoes",cost:"54.95",type:"cross country"});
            crossCountryAr.push({item:"shorts",cost:"18.99",type:"cross country"});
            crossCountryAr.push({item:"shirt",cost:"16.23",type:"cross country"});  
            let rand=Math.floor(Math.random()*crossCountryAr.length);
            return crossCountryAr[rand];
        }
