...
//ADD NAMES - SHUFFLE INFO - GET RANDOM INT FUNCTIONS
        function kayak(){
            let kayakAr=[];
            kayakAr.push({item:"kayak",cost:"889.00",type:"kayak"});
            kayakAr.push({item:"kayak paddle",cost:"105.35",type:"kayak"});
            kayakAr.push({item:"spray skirt",cost:"45.90",type:"kayak"});
            kayakAr.push({item:"wetsuit",cost:"55.45",type:"kayak"});
            kayakAr.push({item:"water pump",cost:"25.35",type:"kayak"});
            kayakAr.push({item:"life jacket",cost:"37.22",type:"kayak"});
            let rand=Math.floor(Math.random()*kayakAr.length);
            return kayakAr[rand];
        }
